...
|  Validium   | StateTransition |    [PolygonValidiumEtrog](https://github.com/agglayer/agglayer-contracts/blob/v12.1.5/contracts/consensus/validium/PolygonValidiumEtrog.sol)     |   FEP # Hermez   |  legacy-cdk-erigon |          ❌          |         ❌        |            ❌           |     ❌    |     ❌    |    ❌   |
