...
### 2.2 Current issue
On SovereignChains, a new approach to allow more features on the wrapped Tokens has been implemented: [custom mappings](https://github.com/agglayer/agglayer-contracts/blob/v11.0.0/contracts/v2/sovereignChains/BridgeL2SovereignChain.sol#L330). This feature currently works given the featured wanted: extend the wrappedToken features.
